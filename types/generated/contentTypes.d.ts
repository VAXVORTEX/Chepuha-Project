...
export interface ApiAnswerAnswer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    positionInSheet: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    storySheet: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiStorySheetStorySheet extends Struct.CollectionTypeSchema {
  collectionName: 'story_sheets';
  info: {
    displayName: 'StorySheet';
    pluralName: 'story-sheets';
    singularName: 'story-sheet';
  };
  options: {
    draftAndPublish: true;
  };
